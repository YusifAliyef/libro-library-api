...
export class CreateBookDto {
  ...
  @Length(2, 100, {
    message: "Kitabın adı minimum 2, maksimum 100 simvol olmalıdır!",
  })
  title: string;
  ...
  @Length(10, 20, {
    message: "ISBN nömrəsi düzgün uzunluqda olmalıdır (10-20 simvol)!",
  })
  isbn: string;
  ...
  @IsOptional()
  @IsArray({ message: "categoryIds massiv olmalıdır!" })
  @IsNumber({}, { each: true, message: "Hər categoryId rəqəm olmalıdır!" })
  categoryIds?: number[];
}